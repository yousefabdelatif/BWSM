<?php
require "model/AppModel"; 
require "view/AppView"; 
require("controller\Utils\UplodedFile");
require("controller\PosterController");
require("model\FriendSuggestionSystemModel");
require("view\FriendSuggestionSystemView");
include_once("ErrorHandler\ErrorHandler");
include_once("controller\AppRoutes\AppRoutes");
